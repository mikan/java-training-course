...
public class Vehicle {
	...
	public static void main(String[] args) {
		if (args == null) {
			...
			for (String name : args) {
				Vehicle v = new Vehicle(new Battery(), name);
	 ...
	 */
	public Vehicle(EnergySource source, String name) {
	...
	/**
	 * 車の動力を開始します。
	 * @IllegalStateException 動力源がない場合
	 */
	public void start() {
		if (energySource == null || energySource.empty()) {
	 ...
	 * 
	 * @param direction
	 *            TURN_LEFT または TURN_RIGHT で指定
	 * @throws NullPointerException
	 *             引数が null の場合
	 * @throws IllegalArgumentException
	 *             TURN_LEFT か TURN_RIGHT でない場合
	 */
