...
public class DigitalClockPopupMenu extends JPopupMenu {
    ...
    public DigitalClockPopupMenu(JWindow window, DigitalClockPanel panel) {
	...
	for (Font f : ge.getAllFonts()) {
	    ...
	    item.addActionListener(new ChangeFontListener(window, panel));
	    fontMenu.add(item);
	}
	...
	// [Font size] -> (size...)
	ChangeFontSizeListener fontSizeListener = new ChangeFontSizeListener(window, panel);
